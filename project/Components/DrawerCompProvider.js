...
const DrawerCompProvider = (props) => {
    ...
    <DrawerContentScrollView contentContainerStyle={{
      ...
      <View style={{ flex: 1, backgroundColor: '#F3F7F1' }}>
        ...
        <View style={{ height: hp(50), justifyContent: 'space-between' }}>
          <TouchableOpacity onPress={() => props.navigation.navigate('Homeprov')} style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: wp(6), }}>
          ...
          <TouchableOpacity onPress={() => props.navigation.navigate('Newschedule')} style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: wp(6) }}>
        ...
        <TouchableOpacity onPress={() => dispatch(addUser(null))} style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: wp(6), marginTop: hp(24.3) }}>
...
export default DrawerCompProvider
